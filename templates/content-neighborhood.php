	...
	<?php if ( have_rows( 'feature_galleries' ) ) : while ( have_rows( 'feature_galleries' ) ) : the_row(); ?>
		<li class="neighborhood-main--lifestyle-list-item">
			<article class="list-item-main">
				...
				<img class="gallery--display-image" width='480' height='480' src="<?php echo esc_html( get_sub_field( 'gallery_tile_image' ) ); ?>" alt="<?php echo esc_html( get_sub_field( 'gallery_name' ) ); ?>">
			</article>
				...
				<div class="gallery-slider owl-carousel owl-theme">
					<?php if ( have_rows( 'gallery_images' ) ) : while ( have_rows( 'gallery_images' ) ) : the_row(); ?>
						<div class="gallery-slide">
							<?php if ( ! wp_is_mobile() ) : ?>
								<img src="<?php echo esc_html( get_sub_field( 'gallery_image' ) )['sizes']['large']; ?>">
							<?php else : ?>
								<img src="<?php echo esc_html( get_sub_field( 'gallery_image' ) )['sizes']['thumbnail']; ?>">
							<?php endif; ?>
